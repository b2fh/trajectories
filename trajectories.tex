...
\caption{The primordial scalar and tensor power spectra for single-field inflation model defined in eq.~\eqref{eq:pot}. The parameters are $m=5.7\times 10^{-6}M_p$, $\mu = 0.1$. \label{fig:bumppower}}
\end{figure}
